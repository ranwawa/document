...
- 30. :已解决:markdown all in one 自动更新 TOC 的功能不生效(2022-10-18)
- :已解决:30. merge editor 的复选框不见了(2022-11-13)
...
toc 链接中的中文字符导致的...在设置中把 toc 的链接功能关掉即可

## :已解决:30. merge editor 的复选框不见了(2022-11-13)

### 问题描述

今年 vscode 的新功能,类似 webstorm 那样解决代码冲突.有冲突的地方会有个复选框让你选择.结果不知道怎么会事儿主复选框就没了.
...
```shell
"git.mergeEditor": true, # 默认使用merge editor处理冲突
"mergeEditor.showCheckboxes": true, # 显示复选框
```
