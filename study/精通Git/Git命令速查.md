...
| --------------------------------------------- | -------------------------------------- |
| git branch                                    | 查询所有本地分支                       |
| git branch -la                                | 查询所有分支(本地+远程)                |
| git branch -d name                            | 删除指定分支                           |
| git branch -dr name                           | 删除本地分支和远程分支的关联关系       |
...
| git push origin 0.0.1             | 将 tag 推送到远程 |
...
| git push --delete 远程仓库名 远程分支名 | 删除远程分支                           |
...
| 命令                  | 含义                                                |
| --------------------- | --------------------------------------------------- |
| git count-objects -vH | verbose, human 以人类可读的格式显示所有包的大小信息 |
