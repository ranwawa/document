...
- 24 :已解决:testEnvironment 详解(2022-05-27)
- 25 :已解决:ReferenceError: DragEvent is not defined(2022-12-09)
...
- 参考: [官方文档](https://jestjs.io/docs/webpack#mocking-css-modules)
...
就是 jestdom 没有实现浏览器这个接口导致的,可怎么解决呢

### 问题解决

查了下 jsdom 官方 issues,官方不准备实现这个接口,那就只能自己 hack 一个
...
- [jsdom 官方 issues](https://github.com/jsdom/jsdom/issues/2913)
- [nx 上的 issues](https://github.com/nrwl/nx/issues/1178)
- [jest 模拟 jsdom 不存在的方法官方文档](https://jestjs.io/docs/manual-mocks#mocking-methods-which-are-not-implemented-in-jsdom)
- [全局注入配置 jest 官方文档](https://jestjs.io/docs/configuration#setupfiles-array)
